...
\centering  
\subfigure[Reconocimiento]{\includegraphics[width=0.2\linewidth]{Figures/combate.png}}
\subfigure[Mapeo de áreas]{\includegraphics[width=0.2\linewidth]{Figures/Reconocimiento.png}}
\subfigure[Transporte]{\includegraphics[width=0.2\linewidth]{Figures/Transporte.png}}
\subfigure[Espectáculo]{\includegraphics[width=0.2\linewidth]{Figures/world.png}}
