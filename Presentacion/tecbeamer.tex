...
% Theme setup
\titlegraphic{\includegraphics[scale=0.03]{Figures/ITL.drawio.png}}
...
\usepackage{tikz}
\setbeamertemplate{background}{\tikz[overlay,remember picture]\node[opacity=0.35]at (current page.center){\includegraphics[width=12cm]{Figures/R.png}};}
...
\newcommand{\R}{\mathbb{R}}  % Doble R   
\newcommand{\sen}{\operatorname{sen}} % Sin en español
...
\newcommand{\tanhh}{\operatorname{tanh}}