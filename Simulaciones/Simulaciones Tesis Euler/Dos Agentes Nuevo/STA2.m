...
YD1_STA     = YD1(pm:end); 
ZD1_STA     = ZD1(pm:end);
PHID1_STA   = PHID1(pm:end);
THETAD1_STA = THETAD1(pm:end);
PSID1_STA   = PSID1(pm:end);
...
save('STSMC_Errores.mat','EX1_STA','EX2_STA','EY1_STA','EY2_STA','EZ1_STA','EZ2_STA','EPHI1_STA','EPHI2_STA','ETHETA1_STA','ETHETA2_STA','EPSI1_STA','EPSI2_STA','t','-v7.3');
save('STSMC_Estados.mat','X1_STA','X2_STA','Y1_STA','Y2_STA','Z1_STA','Z2_STA','PHI1_STA','PHI2_STA','THETA1_STA','THETA2_STA','PSI1_STA','PSI2_STA','-v7.3');
save('STSMC_Deseadas.mat','XD1_STA','XD2_STA','YD1_STA','YD2_STA','ZD1_STA','ZD2_STA','PHID1_STA','PHID2_STA','THETAD1_STA','THETAD2_STA','PSID1_STA','PSID2_STA','-v7.3')
save('STSMC_Control.mat','UZ1_STA','UZ2_STA','TAUPHI1_STA','TAUPHI2_STA','TAUTHETA1_STA','TAUTHETA2_STA','TAUPSI1_STA','TAUPSI2_STA','-v7.3')
