...
zeta_phi = 41.55;
k0_phi = 7.7*zeta_phi^(-1/2);
k1_phi = 7.5*zeta_phi^(2/3);
k2_phi = 2*zeta_phi;

zeta_theta = 41.55;
k0_theta = 7.7*zeta_theta^(-1/2);
k1_theta = 7.5*zeta_theta^(2/3);
k2_theta = 2*zeta_theta;

zeta_psi=1;
k0_psi=7.7*zeta_psi^(-1/2);
k1_psi=7.5*zeta_psi^(2/3);
k2_psi=2*zeta_psi;
...
XD1_NTSMC     = XD1(pm:end);
YD1_NTSMC     = YD1(pm:end); 
ZD1_NTSMC     = ZD1(pm:end);
PHID1_NTSMC   = PHID1(pm:end);
THETAD1_NTSMC = THETAD1(pm:end);
PSID1_NTSMC   = PSID1(pm:end);
...
save('STSMC_Errores.mat','EX1_NTSMC','EX2_NTSMC','EY1_NTSMC','EY2_NTSMC','EZ1_NTSMC','EZ2_NTSMC','EPHI1_NTSMC','EPHI2_NTSMC','ETHETA1_NTSMC','ETHETA2_NTSMC','EPSI1_NTSMC','EPSI2_NTSMC','t','-v7.3');
save('STSMC_Estados.mat','X1_NTSMC','X2_NTSMC','Y1_NTSMC','Y2_NTSMC','Z1_NTSMC','Z2_NTSMC','PHI1_NTSMC','PHI2_NTSMC','THETA1_NTSMC','THETA2_NTSMC','PSI1_NTSMC','PSI2_NTSMC','-v7.3');
save('STSMC_Deseadas.mat','XD1_NTSMC','XD2_NTSMC','YD1_NTSMC','YD2_NTSMC','ZD1_NTSMC','ZD2_NTSMC','PHID1_NTSMC','PHID2_NTSMC','THETAD1_NTSMC','THETAD2_NTSMC','PSID1_NTSMC','PSID2_NTSMC','-v7.3')
save('STSMC_Control.mat','UZ1_NTSMC','UZ2_NTSMC','TAUPHI1_NTSMC','TAUPHI2_NTSMC','TAUTHETA1_NTSMC','TAUTHETA2_NTSMC','TAUPSI1_NTSMC','TAUPSI2_NTSMC','-v7.3')
...
subplot(mtr,ntr,5)
hold on
plot(t,THETAD2_NTSMC)
plot(t,THETAD1_NTSMC)
plot(t,THETA2_NTSMC)
plot(t,THETA1_NTSMC)
% title('Trayectoria Deseada','FontSize',16,'interpreter','latex')
ylabel('$m$','FontSize',16,'interpreter','latex')  
