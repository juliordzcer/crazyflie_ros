...
class AttitudePublisher:
    def __init__(self):
        ...
        self.thrust_sub = rospy.Subscriber('cmd_vel', Twist, self.thrust_callback)
        self.yaw_sub = rospy.Subscriber('vrpn_client_node/crazyflie/pose', PoseStamped, self.yaw_callback)
        self.attitude_pub = rospy.Publisher('info_leader', Twist, queue_size=50)
    ...
    def publish_attitude(self):
        ...
        self.thrust_newton = self.thrust_gramos * 0.00980665
