...
class FollowerNode():
    def __init__(self):
        ...
        self.formation_x = rospy.get_param('~xf', 0.0)
        self.formation_y = rospy.get_param('~yf', 0.0)
        self.formation_z = rospy.get_param('~zf', 0.0)
        self.formation_yaw = rospy.get_param('~yawf', 0.0)
