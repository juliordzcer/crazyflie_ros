...
public:
    ...
    Controller(
        ...
        , m_TCRoll(
            get(n, "TCs/Roll/zeta"),
            get(n, "TCs/Roll/minOutput"),
            get(n, "TCs/Roll/maxOutput"),
            get(n, "TCs/Roll/integratorMin"),
            get(n, "TCs/Roll/integratorMax"),
            "roll")
        , m_TCPitch(
            get(n, "TCs/Pitch/zeta"),
            get(n, "TCs/Pitch/minOutput"),
            get(n, "TCs/Pitch/maxOutput"),
            get(n, "TCs/Pitch/integratorMin"),
            get(n, "TCs/Pitch/integratorMax"),
            "pitch")
        , m_TCYaw(
            get(n, "TCs/Yaw/zeta"),
            get(n, "TCs/Yaw/minOutput"),
            get(n, "TCs/Yaw/maxOutput"),
            get(n, "TCs/Yaw/integratorMin"),
            get(n, "TCs/Yaw/integratorMax"),
            "yaw")
        ...
        case Automatic:
            {
                ...
                msg.angular.x = m_TCYaw.update(0.0, roll);
                msg.angular.y = m_TCYaw.update(0.0, pitch);
                msg.angular.z = m_TCYaw.update(0.0, yaw);
                m_pubNav.publish(msg);

                // float r=0;
                // float p=0;
                // float y=0;
                // r=m_TCRoll.control(0.0, roll);
                // p=m_TCPitch.control(0.0, pitch);
                // y=m_TCYaw.control(0.0, yaw);
                
                // ROS_INFO("roll: %f \n pitch: %f \n yaw: %f \n output Roll: %f \n Output Pitch: %f \n Output Yaw: %f  ",msg.angular.x,r,msg.angular.y,p,msg.angular.z,y);
            }
            break;
        case Idle:
            {
